...
def main():
    ...
    ################## 여기서부터는 유사도 검색
    base_feature = np.load('/content/drive/My Drive/Colab Notebooks/Train_for_pca_DIY')
    base_feature_label = np.load('/content/drive/My Drive/Colab Notebooks/Train_label_for_pca_DIY')
    ...
    vlad_model.load_state_dict(torch.load('/content/drive/My Drive/Colab Notebooks/VLAD_Checkpoint_20200609_Best_DIY_total.pth'), strict=True)
